# Пример проекта — демо-сборка

Эта страница собирает разделы для демо: обзор, роль, архитектура, решения, дорожная карта и демонстрация.
...
- [Архитектура и интеграции](#_5)
- [Решения, компромиссы и риски](#_7)
- [Дорожная карта и демонстрация](#_8)
